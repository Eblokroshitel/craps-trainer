import { generatePlaceQuestion } from "./place_questions.js";
import { placeBetPayout } from "./place_bets.js";
...
function showQuestion() {
    currentQuestion = generatePlaceQuestion();
...
checkButton.addEventListener("click", () => {
    ...
    const correctAnswer = placeBetPayout(
